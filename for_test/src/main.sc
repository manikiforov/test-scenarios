...
theme: /
    ...
    state: newNode_0
        random:
            a: Update-Привет! Вы записаны на прием к врачу на завтрашний день. Подтвердите, пожалуйста, ваше присутствие.
        go!: /newNode_1
    @IntentGroup
        {
          "boundsTo" : "/newNode_0",
    ...
    state: newNode_2
        random:
            a:  UPD-Спасибо за информацию! Ждем вас в назначенное время...
                Хорошего дня!
        go!: /newNode_3
    @EndSession
        {
