...
theme: /
    ...
    state: newNode_0
        random:
            a: Превед! Вы записаны на прием к врачу на завтрашний день. Подтвердите, пожалуйста, ваше присутствие.
        go!: /newNode_1
    @IntentGroup
        {
          "boundsTo" : "/newNode_0",
    ...
    state: newNode_4
        random:
            a: UPD-Хотели бы вы перенести ваш прием на другое время или планируете отказаться от посещения?
        go!: /newNode_5
    @IntentGroup
        {
          "boundsTo" : "/newNode_4",
