...
theme: /
    ...
    state: newNode_0
        random:
            a: Приветики-пистолетики! Вы записаны на прием к врачу на завтрашний день. Подтвердите, пожалуйста, ваше присутствие.
        go!: /newNode_1
    @IntentGroup
        {
          "boundsTo" : "/newNode_0",
    ...
    state: newNode_2
        random:
            a:  Спасибки за информацию! Ждем вас в назначенное время.
                Хорошего дня!
        go!: /newNode_3
    @EndSession
        {
